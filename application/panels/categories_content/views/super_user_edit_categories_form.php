	                             		...
	                             		<div class="row">
	                         				...
	                         				<?php if(isset($result->resource_name) && $result->resource_name!=""){ ?>
			                             			...
			                             			<?php if($result->resource_type=='video/mp4'){?>
													    ...
													    <source src="<?php echo resource_path ?>/categories/videos/<?php echo $result->resource_name ?>" type="video/mp4">
														</video>
				                             			<a class="btn btn-danger" onclick="deleteresource('<?php echo $result->category_id ?>')">Delete</a>
													<?php }else{ ?>
														
														<img src="<?php echo resource_path ?>/categories/images/<?php echo $result->resource_name ?>" class="img-rounded" width="150px" height="150px" />
				                             			<a class="btn btn-danger" onclick="deleteresource('<?php echo $result->category_id ?>')">Delete</a>	
				                             		<?php }
													?>
												</div>
