                          ...
                          <div class="form-group datepicker" style="display: <?php if(isset($user_add_data['sendnewletter'])){if($user_add_data['sendnewletter']=='Schedule'){ echo 'block';}else{ if($user_add_data['sendnewletter']=='Draft'){ echo 'none'; }}}else{ echo 'none'; } ?>;">
                 		 	...
                 		 	<div class="form-group selectgroup" ><label class="col-sm-2 control-label">Select Group*</label>
                               ...
                               <!-- </div> -->
              					...
              					<div class="form-group selectstoriesdropbox" style="display: <?php if(isset($user_add_data['selectgroupfornewsletter']) && $user_add_data['selectgroupfornewsletter']=='stories' ){
              						 echo 'block';
}
								 else{ if(isset($user_add_data['selectgroupfornewsletter']) && $user_add_data['selectgroupfornewsletter']=='allusers'){ echo 'none'; }
									else{echo 'none';}
								 } ?>;">
