                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        ...
                        <div class="ibox-content">
                              <form  method="post" action="<?php echo $this->config->base_url();?>pages_content/super_admin_update_page" class="form-horizontal" id="create_admin_form" name="create_admin_form">
                               
                                
                                <div class="form-group">
                                	<label class="col-sm-2 control-label">Meta Title*</label>
										<input type="hidden" value="<?php echo $result->Id ?>" id="edit_page_id" name="edit_page_id">
                                    <div class="col-sm-4">
                              ...
                              <label class="col-sm-2 control-label">Slug*</label>
							    ...
							    <input type="text" placeholder="Enter Slug" class="form-control"  name="slug" id="slug" value="<?php echo $result->slug; ?>" >
                                    ...
                                    <div class="col-sm-4">
                                 <input type="text" placeholder="Enter Heading" class="form-control"  name="pagehead" id="pagehead" value="<?php echo $result->page_heading; ?>"></div>
								
                          	 		 </div>
                          	 		 <div class="form-group">
								 <label class="col-sm-2 control-label">Page Content*</label>
              <div class="col-sm-10"><textarea class="ckeditor" placeholder="Enter Template Html Body" class="form-control"  name="pagecontent" id="pagecontent"  >
