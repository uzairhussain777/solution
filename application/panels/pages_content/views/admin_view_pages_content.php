                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>All Page Records</h5>
                        </div>
                        <div class="ibox-content">
					<form method="post" action="<?php echo $this->config->base_url()?>pages/search">
							<div class="col-sm-3">
                               ...
                               <?php if(!empty($pages)){
								...
								<tr>
                                  ...
                                  <?php  if($permission){
                                  	...
                                  	<td>
                                	<a href="<?php echo $this->config->base_url();?>pages/edit?pageid=<?php echo $key->Id; ?>"class="btn btn-primary btn-xs" data-toggle="tooltip	" title="Edit">
                                		<span class="glyphicon glyphicon-pencil"></span>
                                		</button>
                                		</a>
                                		
                                		 <a class="open-AddBookDialog-assign btn btn-danger btn-xs" data-id="<?php echo $key->Id;?>" data-title="Delete" data-toggle="modal" data-target="#assingModal" data-toggle="tooltip" title="Delete">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-body">
        <p style="text-align: center;"><strong>Are you sure you want to delete this page?<br />
       </strong></p>
        <div class="col-md-6 ">
...
<script>
	$(document).on("click", ".open-AddBookDialog-assign", function () {
	 ...
	 old_href='<?php echo $this->config->base_url()."pages_content/super_admin_delete_page";?>';
