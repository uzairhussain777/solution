                ...
                <div class="col-lg-12">
                    <div class="ibox float-e-margins">
                        <div class="ibox-title">
                            <h5>Add SEO Setting</h5>
                        </div>
                        <div class="ibox-content">
                            <form  method="post" action="<?php echo $this->config->base_url();?>seo_content/addnewseo" class="form-horizontal" id="create_admin_form" name="create_admin_form">
